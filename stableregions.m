...
%dthvalb = dthrange(LOW) : DEL : 0;      % dTheta0 <= 0

sr2 = @(arg) (((2*mgL)/(Icom + mL2)) * (- cosd(arg) - cosd(B/2) + ...
...
sr2t = @(arg) a * ( (b*c/d) - cosd(arg) - e); 

dthvala =   sr2(thvala + B/2);  % Eq 38
dthvalb =  -sr2(thvalb - B/2);  % Eq 39
